...
// The interface (IEditableFireCurve) is listed first.
namespace Landis.Fire
{
    ...
    /// ecoregion.
    /// </summary>
    public interface IEditableFireCurve
        : IEditable<IFireCurve>
    {
        /// <summary>
        /// Severity1 (5 point scale)
        /// </summary>
        ...
        //---------------------------------------------------------------------
        /// <summary>
        /// Severity4 (5 point scale)
        /// </summary>
        InputValue<int> Severity4
        {get;set;}
        //---------------------------------------------------------------------
        /// <summary>
        /// Severity5 (5 point scale)
        /// </summary>
...
namespace Landis.Fire
{
    ...
    /// </summary>
    public class EditableFireCurve
        : IEditableFireCurve
    {
