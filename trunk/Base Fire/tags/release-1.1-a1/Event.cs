...
namespace Landis.Fire
{
        ...
        : AgeCohort.IDisturbance
    {
        ...
        private Event(ActiveSite initiationSite)
        {
            ...
            this.sitesInEvent = new int[Model.Core.Ecoregions.Count];
        ...
        private void Spread(int currentTime)
        {
            ...
            int[] size = new int[Model.Core.Ecoregions.Count]; // in # of sites
            ...
            IEcoregion ecoregion = Model.Core.Ecoregion[initiationSite];
            ...
            else
            {
                ...
                //foreach(IEcoregion eco in Model.Core.Ecoregions)
