...
namespace Landis.Extension.BaseBDA
{
    ...
    public interface IAgent
    {
        ...
        //string LogicalTest { get; set; }
        //string OutbreakLag{get;set;}
        //int TimeSinceLastClimate { get; set; }
        //List<int> OutbreakList;// (a list of timesteps when outbreaks occur)
        ////BDA-Climate
        ////Implementation--------------------
...
namespace Landis.Extension.BaseBDA
{
        ...
        : IAgent
    {
        ...
        public int RegionalOutbreakStatus(int BDAtimestep)
        {
            int ROS = 0;
        ...
        public  int TimeToNext(int Timestep)
        {
            int timeToNext = 0;
