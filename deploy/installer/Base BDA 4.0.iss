...
AppId={{F88066C9-EFD0-403A-96F0-F10C4ABEF840}
...
Source: {#BuildDir}\Landis.Extension.BaseBDA-v4; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Base BDA 4.0.txt"
