Title:			README_BaseBDA3.0
Project:		LANDIS-II Landscape Change Model
Project Component:	Extension-Base-BDA
Component Deposition:	https://github.com/LANDIS-II-Foundation/Extension-Base-BDA
Author:			LANDIS-II Foundation
Origin Date:		15 June 2017
Final Date:		15 June 2017


Welcome to the source code repository for Extension-Base-BDA, a LANDIS-II disturbance extension.

Extension-Base-BDA is designed to simulate tree mortality following major outbreaks of insects and/or disease, 
where major outbreaks are defined as those significant enough to influence forest succession, fire disturbance, 
or harvest disturbance at landscape scales.
